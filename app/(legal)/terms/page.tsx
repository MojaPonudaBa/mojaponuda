    ...
    <div className="mx-auto max-w-3xl px-6 py-16">
      ...
      <div className="mt-8 space-y-6 text-sm leading-relaxed text-muted-foreground">
        <section>
          ...
          <p className="mt-2">
            Korištenjem platforme MojaPonuda.ba prihvatate ove uvjete
        ...
        <section>
          ...
          <p className="mt-2">
            MojaPonuda.ba je SaaS platforma za upravljanje ponudama u javnim
        ...
        <section>
          ...
          <p className="mt-2">
            Odgovorni ste za sigurnost svog naloga i lozinke. MojaPonuda.ba ne
        ...
        <section>
          ...
          <p className="mt-2">
            MojaPonuda.ba je alat za pomoć u pripremi ponuda i ne garantira
